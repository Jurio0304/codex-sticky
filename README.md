...
2026-06-09 🔄 `0.138.0-sticky.1` rebases Codex Sticky on OpenAI Codex `0.138.0` and fixes Sticky Transcript selection copying so the last selected character is included.
